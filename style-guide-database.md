...
```
<!-- GROUP:WRITING-START --> ... <!-- GROUP:WRITING-END -->
<!-- GROUP:MATH-START --> ... <!-- GROUP:MATH-END -->
<!-- GROUP:CODE-START --> ... <!-- GROUP:CODE-END -->
<!-- GROUP:JAX-START --> ... <!-- GROUP:JAX-END -->
<!-- GROUP:FIGURES-START --> ... <!-- GROUP:FIGURES-END -->
<!-- GROUP:REFERENCES-START --> ... <!-- GROUP:REFERENCES-END -->
<!-- GROUP:LINKS-START --> ... <!-- GROUP:LINKS-END -->
