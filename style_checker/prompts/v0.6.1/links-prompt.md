<!-- Prompt Version: 0.6.1 | Last Updated: 2026-02-13 | Reduce false positives for identical text -->
...
7. **NEVER report a violation where the suggested fix is identical to the current text.** If you cannot propose a concrete change that modifies the text, then no violation exists — do NOT report it. A violation means something must change.
